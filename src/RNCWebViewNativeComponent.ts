...
export interface NativeProps extends ViewProps {
  ...
  userAgent?: string;
  onUriChange: DirectEventHandler<{ uri: string }>;
  onCanGoBackChange: DirectEventHandler<{ canGoBack: boolean }>;
  onCanGoForwardChange: DirectEventHandler<{ canGoForward: boolean }>;
}
